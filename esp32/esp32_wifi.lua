...
-- It supports multiple wifi ssid/passwords where it iterates over them 
...
m.wifiAuth = {}
m.wifiAuth[0] = {ssid = "LEDE", password = "rockyrocky"}
m.wifiAuth[1] = {ssid = "linxdots", password = "dotswifi"}
m.wifiAuth[2] = {ssid = "gdzhanghome", password = "gdzhang@xyzhang"}
m.wifiAuth[3] = {ssid = "NETGEAR-main", password = "**"}
-- private properties
m.isInitted = false
m.myIp = nil
m.isConn = false
